...
`CRON_SECRET` is generated by Vercel automatically for projects with crons.
...
Set for Singapore (UTC+8): `0 13 * * *` = 9 PM daily (bowls), `0 1 * * 6` = Sat 9 AM (bath). Free-plan crons fire within the hour.
